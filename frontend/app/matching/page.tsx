import { FaBrain, FaHandshake, FaChartLine, FaFilter, FaRobot } from 'react-icons/fa';
import Navbar from '@/components/Navbar';
<<<<<<< HEAD
import AIEnhancedMatchingComponent from './components/AIEnhancedMatchingComponent';
=======
...
<<<<<<< HEAD
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-8 shadow-sm">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">How Our AI Matching Works</h2>
